...
class UI{
    ...
    static validateInputs(){
        ...
        var licensePlateRegex = /^(?:[A-Z]{3}-\d{3}-[A-Z]{2})|/;
        ...
        if(!licensePlateRegex.test(licensePlate)){
            UI.showAlert('License Plate must be like NNN-NNN-LL','danger');
            return false;
        }
        return true;
    }
...
//Event Add
    document.querySelector('#entryForm').addEventListener('submit',(e)=>{
        ...
        UI.showAlert('Car successfully added to the Rented List','success');
...
//Event Remove
    document.querySelector('#tableBody').addEventListener('click',(e)=>{
        ...
        UI.showAlert('Car successfully removed from Rented list','success');
    })
